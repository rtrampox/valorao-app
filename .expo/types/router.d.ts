...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/_sitemap` | `/api/getEntitlements` | `/api/lib/clientInfo` | `/api/services/getProfile` | `/api/services/logout` | `/api/services/storeAccessToken` | `/api/services/storePuuid` | `/api/services/storeSsidCookie` | `/api/services/storefront` | `/api/types/profile` | `/api/types/storefrontResponse` | `/api/types/types` | `/pages` | `/profile` | `/storefront` | `/styles/colors` | `/styles/constants/Colors`;
